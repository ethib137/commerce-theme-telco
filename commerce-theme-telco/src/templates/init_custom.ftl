<#assign
	...
	telco_content_css_class = "telco-content"
	translucent_topbar = getterUtil.getBoolean(themeDisplay.getThemeSetting("translucent-topbar"))
	telco_topbar_css_class = "telco-topbar"
/>

<#if wide_layout>
	<#assign
	telco_content_css_class = "telco-content telco-content--wide"
	/>
</#if>

<#if translucent_topbar>
	<#assign
	telco_topbar_css_class = "telco-topbar telco-topbar--translucent"
	/>
</#if>
