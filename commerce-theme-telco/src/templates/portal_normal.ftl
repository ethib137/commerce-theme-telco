...
<html class="${root_css_class}" dir="<@liferay.language key="lang.dir" />" lang="${w3c_language_id}">
	<head>
		...
		<script type="text/javascript" src="${javascript_folder}/standalone/TelcoSlider.js" defer></script>
		<@liferay_util["include"] page=top_head_include />
	</head>

	<body class="telco ${css_class}">
		<div id="wrapper">
			...
			<main class="telco-frame" id="telco">
				<div class="telco-frame__topbar">
					<#include "${full_templates_path}/topbar.ftl" />
				</div>

				<#if telco_content_css_class?contains("wide")>
				<div class="telco-frame telco-frame__content--wide">
				<#else>
				<div class="telco-frame telco-frame__content">
				</#if>
					<a name="telco-top"></a>

					<div class="container-fluid ${telco_content_css_class}">
						<#if selectable>
				...
				<footer class="telco-footer">
					<!-- div class="telco-footer__info">
					...
					<div class="telco-footer__closing">
