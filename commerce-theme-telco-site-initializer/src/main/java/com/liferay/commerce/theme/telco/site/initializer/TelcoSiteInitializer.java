...
@Component(
	immediate = true,
	property = "site.initializer.key=" + TelcoSiteInitializer.KEY,
	service = SiteInitializer.class
)
public class TelcoSiteInitializer implements SiteInitializer {

	public static final String KEY = "telco-initializer";
	...
	public String getDescription(Locale locale) {
		...
		return LanguageUtil.get(resourceBundle, "telco-description");
	}
	...
	public void initialize(long groupId) throws InitializationException {
		try {
			...
			_cpFileImporter.updateLookAndFeel(
				_TELCO_THEME_ID, false, serviceContext);
			...
			_telcoLayoutsInitializer.initialize(serviceContext);
	...
	public boolean isActive(long companyId) {
		...
		if (theme == null) {
			System.out.println(_TELCO_THEME_ID + " is not registered");
	...
	protected void setDefaultCatalogImage(
		...
		ClassLoader classLoader =
			_telcoDependencyResolver.getImageClassLoader();

		InputStream inputStream = classLoader.getResourceAsStream(
			_telcoDependencyResolver.getImageDependencyPath() +
				"Telco_ProductImage_Default.png");
		...
		try {
			...
			FileEntry fileEntry = TempFileEntryUtil.addTempFileEntry(
				...
				TelcoSiteInitializer.class.getName(), file.getName(), file,
				mimeType);
	...
	protected void updateThemeSetting(
		...
		Theme theme = _themeLocalService.fetchTheme(
			serviceContext.getCompanyId(), _TELCO_THEME_ID);
	...
	private JSONArray _getJSONArray(String name) throws Exception {
		return _jsonFactory.createJSONArray(
			_telcoDependencyResolver.getJSON(name));
	}
	...
	private void _importCommerceAccounts(ServiceContext serviceContext)
		...
		_commerceAccountsImporter.importCommerceAccounts(
			jsonArray, _telcoDependencyResolver.getImageClassLoader(),
			_telcoDependencyResolver.getDependenciesPath(),
			serviceContext.getScopeGroupId(), serviceContext.getUserId());
	...
	private void _importDLFileEntries(ServiceContext serviceContext)
		...
		_dlImporter.importDocuments(
			jsonArray, _telcoDependencyResolver.getDocumentsClassLoader(),
			_telcoDependencyResolver.getDocumentsDependencyPath(),
			serviceContext.getScopeGroupId(), serviceContext.getUserId());
	...
	private void _importPortletSettings(ServiceContext serviceContext)
		...
		_portletSettingsImporter.importPortletSettings(
			jsonArray,
			_telcoDependencyResolver.getDisplayTemplatesClassLoader(),
			_telcoDependencyResolver.getDisplayTemplatesDependencyPath(),
	...
	private static final String _TELCO_THEME_ID =
		"telco_WAR_commercethemetelco";

	private static final Log _log = LogFactoryUtil.getLog(
		TelcoSiteInitializer.class);
	...
	@Reference(
		target = "(osgi.web.symbolicname=com.liferay.commerce.theme.telco.site.initializer)"
	)
	...
	@Reference
	private TelcoLayoutsInitializer _telcoLayoutsInitializer;
