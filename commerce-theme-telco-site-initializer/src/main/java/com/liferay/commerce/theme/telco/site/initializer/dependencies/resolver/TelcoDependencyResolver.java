...
package com.liferay.commerce.theme.telco.site.initializer.dependencies.resolver;
 ...
 * @author Marco Leo
 */
@Component(immediate = true, service = TelcoDependencyResolver.class)
public class TelcoDependencyResolver {
	...
	public ClassLoader getDisplayTemplatesClassLoader() {
		return TelcoDependencyResolver.class.getClassLoader();
	}
	...
	public String getJSON(String name) throws IOException {
		return StringUtil.read(
			TelcoDependencyResolver.class.getClassLoader(),
			_DEPENDENCIES_PATH + name);
	}

	private static final String _DEPENDENCIES_PATH =
		"com/liferay/commerce/theme/telco/site/initializer/internal" +
			"/dependencies/";
